...
import {fetchCollectionSuccess, publishHitokotoSuccess, removeHitokotosSuccess} from '../actions'
const mapStoreToProps = (state) => ({layout: state.layout, collections: state.collections, user: state.user})
const mapActionToProps = (dispatch) => ({
  publishHitokotoSuccess: (name) => dispatch(publishHitokotoSuccess(name)),
