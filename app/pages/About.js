    ...
    <FullPageCard cardname="关于">
      <div className={article}>
        ...
        <section className={thanksList}>
          ...
          <ul>
            <li>
              <a href="http://hitokoto.cn" target="_blank" rel="noopener">http://hitokoto.cn</a>
            </li>
            <li>
        ...
        <section className={debug}>
          <h2>项目仓库</h2>
          <p>
            <a href="https://github.com/vankai/hitokoto-pwa" target="_self" rel="noopener">https://github.com/vankai/hitokoto-pwa</a>
          </p>
        </section>
        <section className={debug}>
          <h2>开源协议</h2>
          <Link to='/license'>查看</Link>
        </section>
        <section className={debug}>
          <h2>开发者按钮</h2>
